...
*/
        ...
        JLabel enemy_1 = new JLabel(new ImageIcon("D:/University/Semester8/AP/New folder (2)/project/Images/Bombermans/Player 3/41.gif"));
        enemy_1.setBounds((location.get(0) %(width/50))*50, (location.get(0) /(width/50))*50 , 50 , 50);


        JLabel enemy_2 = new JLabel(new ImageIcon("D:/University/Semester8/AP/New folder (2)/project/Images/Bombermans/Player 3/41.gif"));
        enemy_2.setBounds((location.get(1) %(width/50))*50, (location.get(1) /(width/50))*50 , 50 , 50);


        JLabel enemy_3 = new JLabel(new ImageIcon("D:/University/Semester8/AP/New folder (2)/project/Images/Bombermans/Player 3/41.gif"));
